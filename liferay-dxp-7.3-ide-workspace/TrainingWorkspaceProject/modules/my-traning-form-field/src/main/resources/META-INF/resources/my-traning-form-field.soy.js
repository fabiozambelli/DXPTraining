...
// This file was automatically generated from my-traning-form-field.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace MyTrainingFormField.
 * @public
 */

goog.module('MyTrainingFormField.incrementaldom');
...
$render.Params;
if (goog.DEBUG) {
  $render.soyTemplateName = 'MyTrainingFormField.render';
}
...
function $content(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var attributes__soy35 = function() {
    incrementalDom.attr('class', 'ddm-field-my-traning-form-field form-control my-traning-form-field');
...
$content.Params;
if (goog.DEBUG) {
  $content.soyTemplateName = 'MyTrainingFormField.content';
}
...
export { MyTrainingFormField, templates };
