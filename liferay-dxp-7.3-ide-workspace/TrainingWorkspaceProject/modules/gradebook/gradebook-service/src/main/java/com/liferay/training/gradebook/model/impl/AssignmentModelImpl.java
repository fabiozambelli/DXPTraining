...
public class AssignmentModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"subtitle", Types.VARCHAR}, {"description", Types.VARCHAR},
	...
	static {
		...
		attributeGetterFunctions.put("subtitle", Assignment::getSubtitle);
		attributeSetterBiConsumers.put(
			"subtitle",
			(BiConsumer<Assignment, String>)Assignment::setSubtitle);
	...
	public Object clone() {
		...
		assignmentImpl.setSubtitle(getSubtitle());
	...
	public CacheModel<Assignment> toCacheModel() {
		...
		assignmentCacheModel.subtitle = getSubtitle();

		String subtitle = assignmentCacheModel.subtitle;

		if ((subtitle != null) && (subtitle.length() == 0)) {
			assignmentCacheModel.subtitle = null;
		}
	...
	static {
		...
		columnBitmasks.put("subtitle", 256L);
