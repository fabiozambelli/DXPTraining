 ...
 * <code>com.liferay.training.foo.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.training.foo.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Foo> getFoosByGroupId(long groupId, int start, int end) {
		return getService().getFoosByGroupId(groupId, start, end);
	}

	public static List<Foo> getFoosByGroupId(
		long groupId, int start, int end,
		OrderByComparator<Foo> orderByComparator) {

		return getService().getFoosByGroupId(
