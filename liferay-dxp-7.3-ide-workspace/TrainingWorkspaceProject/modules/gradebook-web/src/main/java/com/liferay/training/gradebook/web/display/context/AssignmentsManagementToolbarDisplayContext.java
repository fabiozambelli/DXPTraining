 ...
 * @author liferay
 */
public class AssignmentsManagementToolbarDisplayContext implements ManagementToolbarDisplayContext {
	...
	public AssignmentsManagementToolbarDisplayContext(
		...
		_assignmentPermission = assignmentPermission;
	...
	*/
	...
	private final AssignmentPermission _assignmentPermission;
