package handless.foo.client.resource.v1_0;
...
import handless.foo.client.problem.Problem;
...
public interface FooResource {
	...
	public HttpInvoker.HttpResponse getFooHttpResponse(String fooId)
		throws Exception;
	...
	public static class FooResourceImpl implements FooResource {
		...
		public HttpInvoker.HttpResponse getFoosPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/handless-foo/v1.0/foos");
		...
		public HttpInvoker.HttpResponse postFooBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/handless-foo/v1.0/foos/batch");
		...
		public HttpInvoker.HttpResponse getFooHttpResponse(String fooId)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/handless-foo/v1.0/foos/{fooId}");
