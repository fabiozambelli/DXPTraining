package handless.foo.internal.graphql.servlet.v1_0;

import com.liferay.portal.vulcan.graphql.servlet.ServletData;

import handless.foo.internal.graphql.mutation.v1_0.Mutation;
import handless.foo.internal.graphql.query.v1_0.Query;
...
public class ServletDataImpl implements ServletData {
	...
	public String getPath() {
		return "/handless-foo-graphql/v1_0";
	}
